...
def profile():
    ...
    # IMPLEMENT THIS
    # instanciate the form regardless:
    form = UserUpdateForm()
    ...
    # form is on submit:
    if form.validate_on_submit():
        is_correct_pw = bcrypt.check_password_hash(g.user.password, form.password.data)
        if is_correct_pw:
            # grab the rest of the data and add them to the user instance:
